    ...
    document.addEventListener('nueva-notificacion-recibida', (e) => {
        ...
        if (notif.tipo === 'caso' || (notif.titulo && notif.titulo.toLowerCase().includes('nuevo caso'))) {
            ...
            if (tbody) {
                ...
                tr.innerHTML = `
                    <td><span class="radicado-link">${radicado}</span></td>
                    <td><span class="tipo-link">—</span></td>
                    <td class="td-desc"><span class="desc-truncate">${notif.mensaje}</span></td>
                    <td><span class="badge badge-pendiente">En Proceso</span></td>
                    <td class="td-date">${new Date().toLocaleDateString()}</td>
                    <td><a href="/casos" class="btn-ver">Ver</a></td>
                `;
