    ...
    <div class="w-full max-w-md px-6">
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            <div class="p-8">
                ...
                <form method="POST" action="<?php echo e(route('password.change.update')); ?>" class="space-y-6" id="passwordForm">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/resources/views/auth/cambiar-password.blade.php ENDPATH**/ ?>