    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 bg-white relative">
        <div class="w-full max-w-sm">
            ...
            <div class="flex flex-col items-center mb-10">
                <img src="<?php echo e(asset('imagenes/federacion cafeteros logo.png')); ?>" alt="Federación Nacional de Cafeteros de Colombia" class="w-40 mb-3">
            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>" autocomplete="off" class="space-y-5">
                <?php echo csrf_field(); ?>
