<?php $__env->startSection('title', 'Editar Usuario - Sistema Jurídico'); ?>
...
<div class="mb-6 -mx-6 -mt-6 px-6 py-4 border-b border-gray-200 bg-white">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Editar Usuario: <?php echo e($usuario->name); ?></h1>
...
<div class="max-w-3xl bg-white rounded-lg border border-gray-200 shadow-sm p-6">
    <form action="<?php echo e(route('usuarios.actualizar', $usuario->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select name="rol_id" required
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($rol->id); ?>" <?php echo e(old('rol_id', $usuario->rol_id) == $rol->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="area" value="<?php echo e(old('area', $usuario->area)); ?>"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-8 p-4 bg-gray-50 rounded-md border border-gray-200">
            <label class="flex items-center gap-3 cursor-pointer <?php echo e(auth()->id() === $usuario->id ? 'opacity-50' : ''); ?>">
                <input type="checkbox" name="activo" value="1" <?php echo e(old('activo', $usuario->activo) ? 'checked' : ''); ?>

                       <?php echo e(auth()->id() === $usuario->id ? 'disabled' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/usuarios/editar.blade.php ENDPATH**/ ?>