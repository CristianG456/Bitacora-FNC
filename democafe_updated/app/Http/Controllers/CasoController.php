...
class CasoController extends Controller
{
    ...
    public function guardar(StoreCasoRequest $request)
    {
        ...
        // El evento de notificación ahora se emite globalmente desde Notificacion::enviar()
    ...
    public function enviarMensaje(Request $request, Caso $caso)
    {
        ...
        // Emitir evento en tiempo real para el chat
        $mensajeData = [
            'id' => $mensaje->id,
        ...
        event(new \App\Events\NuevoMensajeCaso($mensajeData, $caso->id));
